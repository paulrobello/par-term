...
use crate::testing::{make_block, test_renderer_config};
use crate::traits::{ContentRenderer, RendererConfig, ThemeColors};
...
fn render_line(line: &str) -> crate::types::StyledLine {
