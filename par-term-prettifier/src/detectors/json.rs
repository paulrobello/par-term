...
use crate::regex_detector::RegexDetectorBuilder;
use crate::registry::RendererRegistry;
use crate::types::{DetectionRule, RuleScope, RuleSource, RuleStrength};
...
pub fn create_json_detector() -> crate::regex_detector::RegexDetector {
    RegexDetectorBuilder::new("json", "JSON")
        ...
        .rule(DetectionRule {
            ...
            pattern: Regex::new(r"^(curl|http|httpie|wget)\s+")
                .expect("json_http_command_context: pattern is valid and should always compile"),
            weight: 0.3,
        ...
        .rule(DetectionRule {
            ...
            pattern: Regex::new(r"^(jq|gron|fx)\s+")
                .expect("json_jq_command_context: pattern is valid and should always compile"),
            weight: 0.3,
            scope: RuleScope::PrecedingCommand,
            strength: RuleStrength::Supporting,
            source: RuleSource::BuiltIn,
...
mod tests {
    use super::*;
    use crate::testing::make_block_with_command;
