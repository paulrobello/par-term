...
//!
//! Rule-loading detail (parsing, merging, override application) lives in
//! `rule_loader.rs` (R-43); this file contains only top-level orchestration.

use crate::config::Config;
use crate::config::prettifier::ResolvedPrettifierConfig;
...
use super::rule_loader::{apply_detection_rules, parse_detection_scope};
...
mod tests {
    ...
    use super::super::rule_loader::{load_detection_rules, parse_rule_scope, parse_user_rule};
    use super::super::types::{DetectionRule, RuleScope, RuleSource, RuleStrength};
    use super::*;
    use crate::config::prettifier::*;
    use crate::testing::test_global_config;
