...
//!
//! Preview generation logic lives in [`super::claude_code_preview`].
...
pub use super::claude_code_preview::{RenderedPreview, generate_preview};
...
impl ClaudeCodeIntegration {
    ...
    ///
    /// Delegates to [`super::claude_code_preview::generate_preview`].
    pub fn generate_preview(
        content: &ContentBlock,
        detection: &DetectionResult,
        show_badges: bool,
    ) -> RenderedPreview {
        generate_preview(content, detection, show_badges)
    }
