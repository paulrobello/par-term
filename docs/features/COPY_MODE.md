...
stateDiagram-v2
    ...
    note right of Normal
        COPY mode in status bar
    end note

    note right of Visual
        VISUAL mode in status bar
    end note
...
- [Keyboard Shortcuts](../guides/KEYBOARD_SHORTCUTS.md) - Complete keyboard shortcut reference including copy mode
