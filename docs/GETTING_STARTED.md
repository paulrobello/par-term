...
- **Deep customization** -- 55 background shaders, 12 cursor effects, configurable keybindings, snippets, and automation triggers
...
par-term includes 67 ready-to-use GLSL shaders: 55 background shaders (starfield, matrix rain, CRT effects, plasma, and more) and 12 cursor effect shaders (glow, trail, ripple). These are optional visual enhancements.
