...
1. Ensure you have Rust 1.98+ installed (2024 edition required):
...
- [Custom Shaders Guide](../features/CUSTOM_SHADERS.md) - Shader creation, uniforms, and debugging
- [Integrations](../features/INTEGRATIONS.md) - Shell integration installation and management
