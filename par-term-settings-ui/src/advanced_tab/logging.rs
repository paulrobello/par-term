    ...
    collapsing_section(
        ...
        |ui| {
            ...
            if ui
                ...
                .changed()
            {
                settings.config.session_log.auto_log_sessions = auto_log;
                ...
                egui::ComboBox::from_id_salt("advanced_session_log_format")
                    ...
                    .show_ui(ui, |ui| {
                        for format in SessionLogFormat::all() {
                            ...
                            {
                                settings.config.session_log.session_log_format = *format;
                                settings.has_changes = true;
                                *changes_this_frame = true;
                            }
                        }
            ...
            ui.add_space(4.0);
            ui.label(
                egui::RichText::new(match settings.config.session_log.session_log_format {
            ...
            if ui
                ...
                .changed()
            {
                settings.config.session_log.session_log_redact_passwords = redact;
                settings.has_changes = true;
                *changes_this_frame = true;
            }
