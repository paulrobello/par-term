...
pub(super) static BOX_DRAWING_ENTRIES: &[(char, &[LineSegment])] = &[
    ...
    // ─ Light horizontal
    ('\u{2500}', &[LineSegment::horizontal(V4, A, G, LIGHT_THICKNESS)]),

    // │ Light vertical
    ('\u{2502}', &[LineSegment::vertical(D, V1, V7, LIGHT_THICKNESS)]),
    ...
    // ━ Heavy horizontal
    ('\u{2501}', &[LineSegment::horizontal(V4, A, G, HEAVY_THICKNESS)]),

    // ┃ Heavy vertical
    ('\u{2503}', &[LineSegment::vertical(D, V1, V7, HEAVY_THICKNESS)]),
    ...
    ('\u{2504}', &[LineSegment::horizontal(V4, A, G, LIGHT_THICKNESS)]),

    // ┅ Heavy triple dash horizontal
    ('\u{2505}', &[LineSegment::horizontal(V4, A, G, HEAVY_THICKNESS)]),

    // ┆ Light triple dash vertical
    ('\u{2506}', &[LineSegment::vertical(D, V1, V7, LIGHT_THICKNESS)]),

    // ┇ Heavy triple dash vertical
    ('\u{2507}', &[LineSegment::vertical(D, V1, V7, HEAVY_THICKNESS)]),

    // ┈ Light quadruple dash horizontal
    ('\u{2508}', &[LineSegment::horizontal(V4, A, G, LIGHT_THICKNESS)]),

    // ┉ Heavy quadruple dash horizontal
    ('\u{2509}', &[LineSegment::horizontal(V4, A, G, HEAVY_THICKNESS)]),

    // ┊ Light quadruple dash vertical
    ('\u{250A}', &[LineSegment::vertical(D, V1, V7, LIGHT_THICKNESS)]),

    // ┋ Heavy quadruple dash vertical
    ('\u{250B}', &[LineSegment::vertical(D, V1, V7, HEAVY_THICKNESS)]),
    ...
    ('\u{2571}', &[LineSegment::new(G, V1, A, V7, LIGHT_THICKNESS)]),

    // ╲ Light diagonal upper left to lower right
    ('\u{2572}', &[LineSegment::new(A, V1, G, V7, LIGHT_THICKNESS)]),
    ...
    // ╴ Light left
    ('\u{2574}', &[LineSegment::horizontal(V4, A, D, LIGHT_THICKNESS)]),

    // ╵ Light up
    ('\u{2575}', &[LineSegment::vertical(D, V1, V4, LIGHT_THICKNESS)]),

    // ╶ Light right
    ('\u{2576}', &[LineSegment::horizontal(V4, D, G, LIGHT_THICKNESS)]),

    // ╷ Light down
    ('\u{2577}', &[LineSegment::vertical(D, V4, V7, LIGHT_THICKNESS)]),

    // ╸ Heavy left
    ('\u{2578}', &[LineSegment::horizontal(V4, A, D, HEAVY_THICKNESS)]),

    // ╹ Heavy up
    ('\u{2579}', &[LineSegment::vertical(D, V1, V4, HEAVY_THICKNESS)]),

    // ╺ Heavy right
    ('\u{257A}', &[LineSegment::horizontal(V4, D, G, HEAVY_THICKNESS)]),

    // ╻ Heavy down
    ('\u{257B}', &[LineSegment::vertical(D, V4, V7, HEAVY_THICKNESS)]),
