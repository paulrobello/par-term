...
- **New bundled terminal-aware shader pack** — added 12 background shaders: `progress_reactive_theme.glsl`, `command_state_backdrop.glsl`, `pane_focus_regions.glsl`, `scrollback_parallax.glsl`, `aurora_terminal.glsl`, `blueprint_grid.glsl`, `ink_wash.glsl`, `solarized_nebula.glsl`, `matrix_rain_2.glsl`, `build_reactor.glsl`, `diff_heatmap_glow.glsl`, and `low_power_ambience.glsl`. The included shader count is now 64 total (52 background + 12 cursor).
