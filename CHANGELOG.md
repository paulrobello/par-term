...
### Changed
- Dark Background theme: blue (#0000BB) and bright blue (#5555FF) replaced with more visible values (#4A90E2 and #6BAFFF) that are clearly legible on a black background.
