//! External integration tests for paste transformations and content sanitization.
//!
//! These tests use only the public API from `par_term::paste_transform` and can
//! be run without access to private module internals.
//!
//! Note: The original embedded tests in `src/paste_transform/tests.rs` are kept
//! in place; this file provides equivalent external coverage.

use par_term::paste_transform::{PasteTransform, sanitize_paste_content, transform};
