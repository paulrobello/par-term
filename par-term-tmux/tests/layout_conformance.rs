...
//! grammars diverge.
//!
//! Requires the core's `mux` feature (dev-dependency above), first published
//! in core versions >= 0.50; before that this file compiles only against the
//! local core checkout via the vendoring patch in the repo CLAUDE.md.
