...
| Multiple AI providers | ✅ OpenAI, Anthropic, etc. | ✅ | ✅ | ⭐⭐ | 🔵 | 8 bundled agent configs (Claude Code, Amp, Augment, Copilot, Docker, OpenAI, OpenHands, Oh My Pi) + user-defined TOML configs in `~/.config/par-term/agents/`. Auto-launch configurable agent on panel open. |
...
- ✅ **Assistant Panel** (formerly AI Inspector): DevTools-style right-side panel for terminal state inspection with ACP agent integration (#149)
  ...
  - 8 bundled agent configs (Claude Code, Amp, Augment, Copilot, Docker, OpenAI, OpenHands, Oh My Pi)
