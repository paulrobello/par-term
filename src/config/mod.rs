...
pub use par_term_config::{
    ...
    PaneBackground, PaneBackgroundConfig, PaneConfig, PaneId, PaneTitlePosition, PluginStateConfig,
    PowerConfig, PowerPreference, ProgressBarConfig, ProgressBarPosition, ProgressBarStyle,
    RenderingConfig, ResolvedCursorShaderConfig, ResolvedShaderConfig, ScrollbarConfig,
    SecurityConfig, SelectionConfig, SemanticHistoryConfig, SemanticHistoryEditorMode,
    SeparatorMark, SessionLogConfig, SessionLogFormat, SessionRestoreConfig, ShaderConfig,
    ShaderInstallPrompt, ShaderMetadata, ShaderOverridesConfig, ShaderWatchConfig, ShellConfig,
