            ...
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui| {
                    for profile in profile_manager.profiles_ordered() {
                        ...
                        let is_hovered = self.hovered == Some(profile.id);
                        ...
                        let response = frame.show(ui, |ui| {
                            ui.horizontal(|ui| {
                                ...
                                // Subtle indicator if profile has custom settings
                    ...
                    // Clear hovered state if not over any profile
