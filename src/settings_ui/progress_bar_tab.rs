...
pub fn show(ui: &mut egui::Ui, settings: &mut SettingsUI, changes_this_frame: &mut bool) {
    ...
    if section_matches(
        ...
        show_colors_section(ui, settings, changes_this_frame);
    }
}
...
fn show_general_section(
    ...
    collapsing_section(ui, "General", "progress_bar_general", true, |ui| {
        if ui
            .checkbox(
...
fn show_colors_section(
    ...
    collapsing_section(ui, "State Colors", "progress_bar_colors", true, |ui| {
