...
use super::section::{collapsing_section, subsection_label, INPUT_WIDTH, SLIDER_WIDTH};
...
fn show_fonts_section(
    ...
    collapsing_section(ui, "Fonts", "appearance_fonts", true, |ui| {
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::TextEdit::singleline(&mut settings.temp_font_family).desired_width(INPUT_WIDTH))
                .changed()
            {
        ...
        ui.horizontal(|ui| {
            ui.label("Size:");
            if ui
                .add_sized([SLIDER_WIDTH, 18.0], egui::Slider::new(&mut settings.temp_font_size, 6.0..=48.0))
                .changed()
            {
                settings.font_pending_changes = true;
            }
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_sized([SLIDER_WIDTH, 18.0], egui::Slider::new(&mut settings.temp_line_spacing, 0.8..=2.0))
                .changed()
            {
                settings.font_pending_changes = true;
            }
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add_sized([SLIDER_WIDTH, 18.0], egui::Slider::new(&mut settings.temp_char_spacing, 0.5..=1.0))
                .changed()
            {
                settings.font_pending_changes = true;
            }
...
fn show_font_variants_section(
    ...
    collapsing_section(ui, "Font Variants", "appearance_font_variants", false, |ui| {
        ui.horizontal(|ui| {
            ui.label("Bold font (optional):");
            if ui
                .add(egui::TextEdit::singleline(&mut settings.temp_font_bold).desired_width(INPUT_WIDTH))
                .changed()
            {
                settings.font_pending_changes = true;
            }
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::TextEdit::singleline(&mut settings.temp_font_italic).desired_width(INPUT_WIDTH))
                .changed()
            {
                settings.font_pending_changes = true;
            }
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::TextEdit::singleline(&mut settings.temp_font_bold_italic).desired_width(INPUT_WIDTH))
                .changed()
            {
                settings.font_pending_changes = true;
            }
...
fn show_font_rendering_section(
    ...
    collapsing_section(ui, "Font Rendering", "appearance_font_rendering", false, |ui| {
        if ui
            ...
            egui::ComboBox::from_id_salt("appearance_thin_strokes_mode")
                ...
                .show_ui(ui, |ui| {
                    for (mode, label) in [
                        ...
                        if ui
                            .selectable_label(current_mode == mode, label)
                            .clicked()
                        {
...
fn show_cursor_effects_section(
    ...
    collapsing_section(ui, "Cursor Effects", "appearance_cursor_effects", false, |ui| {
        // Cursor Guide
        if ui
            .checkbox(
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::Slider::new(&mut settings.config.cursor_boost, 0.0..=1.0))
