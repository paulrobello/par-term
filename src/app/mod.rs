...
struct AppState {
    ...
    pub(crate) cache: crate::app::render_cache::RenderCache,

    pub(crate) cursor_opacity: f32, // Cursor opacity for smooth fade animation (0.0 = invisible, 1.0 = fully visible)
    ...
    pub(crate) cursor_blink_timer: Option<std::time::Instant>, // When to blink cursor next
    pub(crate) pending_font_rebuild: bool, // Whether we need to rebuild renderer after font-related changes
}
...
impl AppState {
    ...
    fn new(config: Config, runtime: Arc<Runtime>) -> Self {
        ...
        Self {
            ...
            bell: BellState::new(),
            cache: crate::app::render_cache::RenderCache::new(initial_opacity),
