...
// PAR_MUX_INTEGRATION_ID=pi
// PAR_MUX_INTEGRATION_VERSION=1
// env-renamed port of herdr's pi agent-state extension (herdr 0.9.1); par-mux's
...
const source = "par-mux:pi";

function enabled() {
  return PAR_MUX_ENV === "1" && !!socketPath && !!paneId;
}
